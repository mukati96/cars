...
export class WebViewComponent implements OnInit, OnDestroy, OnChanges, DoCheck {
 public question:any = [
    { text: 'I am interested in purchasing this vehicle' },
    { text: 'I like this car, but i have a few questions' },
    { text: 'I would like to schedule a test drive' },
    { text: 'I would like to see more photos of this vehicle' },
    { text: 'Can you help me finance this vehicle?' },
    { text: 'Can I trade in my current vehicle for this one?' },
    { text: 'Can I get a Pre Purchase Inspection (PPI) done on the vehicle?' },
    { text: 'Can I get a shipping quote to my location?' }
  ]
  value: any = 0;
  clicked = true;
 public Show!: boolean;
